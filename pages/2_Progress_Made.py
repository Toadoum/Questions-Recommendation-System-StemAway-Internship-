...
st.markdown('<h2 style=color:#3CAF0B8B;">General Discussion</h2>', unsafe_allow_html=True)
...
st.markdown('<h3 style=color:#3CAF0B8B;">References</h1>', unsafe_allow_html=True)
...
st.markdown('<h2 style=color:#3CAF0B8B;">Prototyping - Web Scraping</h2>', unsafe_allow_html=True)
